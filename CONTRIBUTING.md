...
Report bugs at https://github.com/npikall/eo_toolbox/issues.
...
eo-toolbox could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/npikall/eo_toolbox/issues.
...
Ready to contribute? Here's how to set up `eo-toolbox` for local development.

1. Fork the `eo-toolbox` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:npikall/eo_toolbox.git
   ```

3. Install your local copy into a virtualenv. Assuming you have [uv] and [Just] installed, this is how you set up your fork for local development:

   ```sh
   # to setup the virtual environment (or use just)
   uv sync
...
```sh
just bump minor  # possible: major / minor / patch and others
git push --tags
```
